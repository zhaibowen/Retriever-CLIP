...
image_paths = [
    '/home/work/coco/images/val2017/000000179765.jpg',
    '/home/work/coco/images/val2017/000000190236.jpg', 
    '/home/work/coco/images/val2017/000000517069.jpg', 
    '/home/work/coco/images/val2017/000000172330.jpg', 
    '/home/work/coco/images/val2017/000000289393.jpg', 
]
    ...
    for image_path in image_paths:
        ...
        with torch.no_grad():
            ...
            with autocast(dtype=ptdtype):
                ...
                tlist.append(similarity)
    sim_list.append(tlist)

confuse_matrix = np.array(sim_list)
